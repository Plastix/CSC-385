...
class PixelArray {
    ...
    render() {
        ...
        let mMV = mult(translate(-1, -1, 0), scalem(2 / this.width, 2 / this.height, 1));
    ...
    init_pixels() {
        ...
        for (let y = 0; y < this.height; y++) {
            for (let x = 0; x < this.width; x++) {
                let lower_left = vec3(x + SPACING, y + SPACING, 0);
                let upper_right = vec3(x + 1 - SPACING, y + 1 - SPACING, 0);
    ...
    clear_pixels() {
        ...
        for (let i = 0; i < this.pixel_colors.length; i++)
