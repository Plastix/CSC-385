...
class Mobile {
    ...
    constructor(root_pos, gl, program) {
        ...
        this.root_rod = null;
        let rod1 = this.add_rod(null, 4, 2, 0, 0.5, 0, 0.75);
        let rod2 = this.add_rod(rod1, 4, 2, 2, 0, 0, -0.5);

        this.add_pendant(rod1, 1, 4, 120, 2, PILLOW_MESH, mult(rotateZ(45), mult(rotateX(45), scalem(0.5, 1, 2))));
        this.add_pendant(rod2, 2.5, 0, 77, -2.5, STAR_MESH, scalem(2, 2, 2));
        this.add_pendant(rod1, 6, 0, 90, 1, SMOOTH_CUBE_MESH, scalem(0.5, 3, 0.5));
        this.add_pendant(rod2, 4, 4, 45, 0.5, SMOOTH_CUBE_MESH, scalem(0.5, 1.75, 0.5));

        let rod3 = this.add_rod(rod1, 4, 1, 3, 4, 30, 0.5);
        this.add_pendant(rod3, 0, 0, -50, 0.5, PILLOW_MESH, rotateX(45));
        this.add_pendant(rod3, 5, 4, 270, 0, SMOOTH_CUBE_MESH, scalem(0.5, 5, 0.5));

        let rod4 = this.add_rod(rod3, 1.5, 0, 2, 1.75, 20, -2.5);
        this.add_pendant(rod4, 1, 0, 0, 0, SMOOTH_CUBE_MESH, rotateX(45));
        this.add_pendant(rod4, 1, 1.5, 0, 3, STAR_MESH, rotateX(45));


        // this.add_pendant(this.root_rod, 0.25, 3.5, 90, 0.1, STAR_MESH, translate(0, -0.5, 0));
        // this.add_pendant(this.root_rod, 1.5, 0, 180, -1, PILLOW_MESH,
